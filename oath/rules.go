...
var normativeRules = []normativeRule{
	...
	{"ENV-FIELD-ORDER", "§8.6.1", "envelope members appear in a fixed order", familyEnvelope},
	{"ENV-FIELD-COUNT", "§8.6.1", "the envelope has exactly the members its format version defines", familyEnvelope},
	{"ENV-LINE-LF", "§8.6.1", "the envelope ends with a newline", familyEnvelope},
	...
	{"ENV-STORE-CAS", "§8.6.4", "the signed parent must be the current binding", familyEnvelope},
	...
	{"LICENSE-MODEL-SCHEMA", "§12.3", "a missing or out-of-vocabulary model value reads UNSTATED, never a grant", familyLicense},
