...
bottom-up through the hash graph like every other verdict. 141 definitions are
fully proven (382 of 635 properties proven overall), including `reverse (reverse xs) == xs` (via the append laws
