...
bottom-up through the hash graph like every other verdict. 192 definitions are
fully proven (521 of 682 properties proven overall), including `reverse (reverse xs) == xs` (via the append laws
