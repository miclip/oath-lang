...
bottom-up through the hash graph like every other verdict. 190 definitions are
fully proven (512 of 649 properties proven overall), including `reverse (reverse xs) == xs` (via the append laws
