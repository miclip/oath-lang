...
bottom-up through the hash graph like every other verdict. 184 definitions are
fully proven (502 of 639 properties proven overall), including `reverse (reverse xs) == xs` (via the append laws
