...
bottom-up through the hash graph like every other verdict. 127 definitions are
fully proven (368 of 513 properties proven overall), including `reverse (reverse xs) == xs` (via the append laws
