...
BASELINE = {
    ...
    'website/app/essays/outside-audit/page.tsx': ['0.7@z', '03@an', '07@corpus', '07@n', '07@registry', '07@solver', '07@website', '123@fully', '134@proven', '136@and', '168@definitions', '18@corpus', '18@n', '18@solver', '18@website', '190@fully', '2026@corpus', '2026@n', '2026@registry', '2026@solver', '2026@website', '207@properties', '218@proven', '243@definitions', '289@properties', '30@registry', '33@model', '348@proven', '37@fully', '38@website', '4.16@definitions', '41@the', '41@with', '427@properties', '49@tested', '4@falsified', '5.5@an', '5.5@an', '50,@model', '50@the', '50@with', '518@proven', '56@definitions', '656@properties', '70@fully', '754@float', '88@definitions'],
